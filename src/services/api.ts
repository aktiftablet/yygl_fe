...
// In development, we might want to point to a specific backend or rely on proxy
// For now we assume the backend is served relative to /api or we set a base URL
